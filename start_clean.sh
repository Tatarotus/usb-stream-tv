...
nohup /data/data/com.termux/files/usr/bin/python3 /data/local/tmp/stream_writer.py 3112 https://tv.smre.run.place globo-rj --fifo=/data/local/tmp/live_pipe >>/data/local/tmp/channel_stream.log 2>&1 &
